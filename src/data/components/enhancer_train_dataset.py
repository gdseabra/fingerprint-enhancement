...
class EnhancerTrainDataset(Dataset):
    def __init__(self, data_dir: str = "data/", data_list: str = None, transform=None, skel_transform = None, lat_subdir = '/latents/', ref_subdir = '/references/', skel_subdir = '/skel/', mask_subdir = '/masks/', apply_mask = 0):
    ...
    def __getitem__(self, ix):
        ...
        return lat, torch.concat([ref, skel, mask], axis=0)
